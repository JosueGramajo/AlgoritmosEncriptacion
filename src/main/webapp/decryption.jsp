                    ...
                    <ul class="list-unstyled">
                        <li>
                            <a href="/encriptacion">
                                ...
                                <span class="bot-line"></span>Encriptación</a>
                        </li>
                        <li>
                            <a href="/desencriptacion">
                                <i class="fas fa-lock-open"></i>
                                <span class="bot-line"></span>Desencriptación</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="form-group" id="box-key">
                            <label for="box-key-input">Ingrese la clave</label>
                            <input type="text" id="box-key-input" class="form-control"/>
                        </div>
                        <script>
                            $("#box-key").hide();
                        </script>
